...
int main(void)
{
    ...
    // SIZEOF OPERATOR
    // sizeof( type-name) -> value expression is unsigned integer .. representing the number of bytes required to store a value belonging to 'type-name'.
    printf("%lu\n", sizeof 'c');
    printf("%lu\n", sizeof 1 ); //!\: important to know that size of is unary operator and takes precedence before binary operator
